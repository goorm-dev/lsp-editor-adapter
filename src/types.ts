...
// seho.ahn
export const CompletionItemKindArray: Array<Array<string>> = [
  ['NULL',          'gi-symbol-null'],
  ['TEXT',          'gi-symbol-text'],
  ['METHOD',        'gi-symbol-method'],
  ['FUNCTION',      'gi-symbol-method'],
  ['CONSTRUCTOR',   'gi-symbol-constructor'],
  ['FIELD',         'gi-symbol-field'],
  ['VARIABLE',      'gi-symbol-variable'],
  ['CLASS',         'gi-symbol-class'],
  ['INTERFACE',     'gi-symbol-interface'],
  ['MODULE',        'gi-symbol-module'],
  ['PROPERTY',      'gi-symbol-property'],
  ['UNIT',          'gi-symbol-unit'],
  ['VALUE',         'gi-symbol-value'],
  ['ENUM',          'gi-symbol-enum'],
  ['KEYWORD',       'gi-symbol-keyword'],
  ['SNIPPET',       'gi-symbol-snippet'],
  ['COLOR',         'gi-symbol-color'],
  ['FILE',          'gi-symbol-file'],
  ['REFERENCE',     'gi-symbol-reference'],
  ['FOLDER',        'gi-symbol-folder'],
  ['ENUMMEMBER',    'gi-symbol-enum'],
  ['CONSTANT',      'gi-symbol-constant'],
  ['STRUCT',        'gi-symbol-constructor'],
  ['EVENT',         'gi-symbol-event'],
  ['OPERATOR',      'gi-symbol-operator'],
  ['TYPEPARAMETER', 'gi-symbol-type-parameter']
];
