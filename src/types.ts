...
export const CompletionItemKindArray: Array<Array<string>> = [
  ...
  ['ENUM',          'gi-common'],
  ['KEYWORD',       'gi-key'],
  ['SNIPPET',       'gi-source-code'],
  ['COLOR',         'gi-drawing'],
  ['FILE',          'gi-file'],
  ['REFERENCE',     'gi-sourcecode'],
  ['FOLDER',        'gi-folder'],
  ['ENUMMEMBER',    'gi-sourcecode'],
  ['CONSTANT',      'gi-sourcecode'],
  ['STRUCT',        'gi-sourcecode'],
  ['EVENT',         'gi-sourcecode'],
  ['OPERATOR',      'gi-sourcecode'],
  ['TYPEPARAMETER', 'gi-sourcecode']
];
